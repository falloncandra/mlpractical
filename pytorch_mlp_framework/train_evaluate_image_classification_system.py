...
elif args.block_type == 'tanh_bn_conv_block':
    processing_block_type = ConvolutionalProcessingBlockWithBatchNormTanH
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlockWithBatchNormTanH
else:
